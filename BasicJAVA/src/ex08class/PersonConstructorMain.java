...
public class PersonConstructorMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("[멤버변수 초기화용 메소드 호출이후]");
		person1.initialize("홍길동", 20, "가산동");
		person1.showPersonInfo();
		...
		System.out.println("[모든 멤버변수를 전달한 값으로 초기화하기]");
		PersonConstructor person4 = new PersonConstructor("박길동",50,"부산");
